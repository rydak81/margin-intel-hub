...
export const DEFAULT_RSS_SOURCES: Omit<NewsSource, 'id' | 'last_fetched_at'>[] = [
  ...
  },
  {
    ...
    slug: 'internet-retailer',
    source_type: 'rss',
    url: 'https://www.digitalcommerce360.com/internet-retailer/',
    feed_url: 'https://www.digitalcommerce360.com/internet-retailer/feed/',
    category: 'ecommerce',
  ...
  },
  {
    ...
    slug: 'search-engine-journal-ecom',
    source_type: 'rss',
    url: 'https://www.searchenginejournal.com/category/ecommerce/',
    feed_url: 'https://www.searchenginejournal.com/category/ecommerce/feed/',
  ...
  },
  {
    ...
    feed_url: 'https://www.freightwaves.com/news/rss',
    category: 'logistics',
    platform: ['general'],
    is_active: true,
    priority_score: 74,
